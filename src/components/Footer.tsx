...
const socialLinks = [
  {
    href: "https://www.instagram.com/salimdadaofficial/",
    label: "Instagram",
    icon: (
  ...
  {
    href: "https://om.linkedin.com/in/salim-dada-15510272/en",
    label: "LinkedIn",
    icon: (
      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    href: "https://www.youtube.com/channel/UC_fl4NsoYgGol9lGRQzc8GQ",
    label: "YouTube",
    icon: (
      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
