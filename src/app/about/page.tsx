        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-end">
          ...
          <div className="md:col-span-4 pb-4">
            <p className="text-on-surface-variant font-body leading-relaxed max-w-sm">
              An exploration of heritage through the lens of orchestral
              composition and the preservation of intangible cultural wealth.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="md:col-span-7">
            <div className="max-w-2xl">
              ...
              <div className="space-y-8 text-lg font-body leading-relaxed text-on-surface-variant">
                <p>
                  Salim Dada stands at the confluence of diverse musical worlds.
                  As a composer, conductor, and musicologist, his work is an
                  ongoing dialogue between the formal rigor of Western polyphony
                  and the profound modal traditions of the Mediterranean.
                </p>
                <p>
                  Born with an innate curiosity for the &ldquo;unwritten,&rdquo;
                  Dada has spent decades transcribing the ephemeral — capturing
                  the nuances of traditional Algerian music and elevating them to
                  the symphonic stage. His compositions are not merely pieces of
                  music; they are archival acts.
                </p>
                <p className="italic text-primary border-l-2 border-primary-container pl-8 py-2">
                  &ldquo;The baton does not just direct the orchestra; it directs
                  the memory of a people back into the present air.&rdquo;
                </p>
                <p>
                  His academic journey across the conservatories of Paris and
                  Algiers provided the technical foundation for what would become
                  a signature style: a harmonic language that is simultaneously
        ...
        <div className="max-w-screen-2xl mx-auto">
          <div className="flex flex-col md:flex-row gap-16">
            ...
            <div className="md:w-2/3 grid grid-cols-1 sm:grid-cols-2 gap-8">
              <div className="bg-surface p-10 rounded-lg shadow-card border border-outline-variant/10">
                ...
                <p className="text-sm text-on-surface-variant leading-relaxed">
                  Serving as a pivotal voice in the evaluation of cultural
                  assets, ensuring the preservation of oral traditions and
                  performing arts across North Africa.
                </p>
              </div>
              <div className="bg-surface p-10 rounded-lg shadow-card border border-outline-variant/10">
                <span className="material-symbols-outlined text-primary mb-6 block">
                ...
                <p className="text-sm text-on-surface-variant leading-relaxed">
                  Leading documentation projects that translate endangered
                  auditory heritages into modern notation for future generations
                  of scholars and performers.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-surface-container-highest p-12 md:p-24 flex flex-col md:flex-row items-center gap-16">
          ...
          <div className="w-full md:w-1/2">
            ...
            <p className="text-on-surface-variant mb-8 leading-relaxed">
              I believe that every culture possesses a &lsquo;silent
              rhythm&rsquo; — a pulse that dictates its movement through
